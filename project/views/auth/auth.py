...
class RegisterView(Resource):
    ...
    def post(self):
        ...
        if data.get('email') and data.get('password'):
            ...
            return "Пользователь не создался, что то пошло не так.", 401
...
class LoginView(Resource):
    def post(self):
        ...
        if data.get('email') and data.get('password'):
            ...
            return "Пользователь не залогинился, что то пошло не так.", 401
    ...
    def put(self):
        ...
        if data.get('access_token') and data.get('refresh_token'):
            ...
            return "Что то пошло не так с токеном", 401
